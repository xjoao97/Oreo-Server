...
using Oreo.Communication.Packets.Incoming.Quiz;
using Oreo.Communication.Packets.Incoming.Catalog;
using Oreo.Communication.Packets.Incoming.Handshake;
using Oreo.Communication.Packets.Incoming.Navigator;
using Oreo.Communication.Packets.Incoming.Quests;
using Oreo.Communication.Packets.Incoming.Rooms.Avatar;
using Oreo.Communication.Packets.Incoming.Rooms.Chat;
using Oreo.Communication.Packets.Incoming.Rooms.Games;
using Oreo.Communication.Packets.Incoming.Rooms.Connection;
using Oreo.Communication.Packets.Incoming.Rooms.Engine;
using Oreo.Communication.Packets.Incoming.Rooms.Action;
using Oreo.Communication.Packets.Incoming.Users;
using Oreo.Communication.Packets.Incoming.Inventory.AvatarEffects;
using Oreo.Communication.Packets.Incoming.Inventory.Purse;
using Oreo.Communication.Packets.Incoming.Sound;
using Oreo.Communication.Packets.Incoming.Misc;
using Oreo.Communication.Packets.Incoming.Inventory.Badges;
using Oreo.Communication.Packets.Incoming.Avatar;
using Oreo.Communication.Packets.Incoming.Inventory.Achievements;
using Oreo.Communication.Packets.Incoming.Inventory.Bots;
using Oreo.Communication.Packets.Incoming.Inventory.Pets;
using Oreo.Communication.Packets.Incoming.LandingView;
using Oreo.Communication.Packets.Incoming.Messenger;
using Oreo.Communication.Packets.Incoming.Groups;
using Oreo.Communication.Packets.Incoming.Rooms.Settings;
using Oreo.Communication.Packets.Incoming.Rooms.AI.Pets;
using Oreo.Communication.Packets.Incoming.Rooms.AI.Bots;
using Oreo.Communication.Packets.Incoming.Rooms.AI.Pets.Horse;
using Oreo.Communication.Packets.Incoming.Rooms.Furni;
using Oreo.Communication.Packets.Incoming.Rooms.Furni.YouTubeTelevisions;
using Oreo.Communication.Packets.Incoming.Help;
using Oreo.Communication.Packets.Incoming.Rooms.FloorPlan;
using Oreo.Communication.Packets.Incoming.Rooms.Furni.Wired;
using Oreo.Communication.Packets.Incoming.Moderation;
using Oreo.Communication.Packets.Incoming.Inventory.Furni;
using Oreo.Communication.Packets.Incoming.Rooms.Furni.Stickys;
using Oreo.Communication.Packets.Incoming.Rooms.Furni.Moodlight;
using Oreo.Communication.Packets.Incoming.Inventory.Trading;
using Oreo.Communication.Packets.Incoming.GameCenter;
using Oreo.Communication.Packets.Incoming.Marketplace;
using Oreo.Communication.Packets.Incoming.Rooms.Furni.LoveLocks;
using Oreo.Communication.Packets.Incoming.HabboCamera;
using Oreo.Communication.Packets.Incoming.QuickPolls;
using Oreo.Communication.Packets.Incoming.Help.Helpers;
using Oreo.Communication.Packets.Incoming.Rooms.Polls;

namespace Oreo.Communication.Packets
{
    public sealed class PacketManager
    {
        private static readonly ILog log = LogManager.GetLogger("Oreo.Communication.Packets");
        ...
        public void TryExecutePacket(GameClient Session, ClientPacket Packet)
        {
            ...
            if (!_incomingPackets.TryGetValue(Packet.Id, out IPacketEvent Pak))
            {
                if (System.Diagnostics.Debugger.IsAttached || ExtraSettings.DEBUG_ENABLED == true)
                    log.Debug("Packet Desconhecido: " + Packet.ToString());
                return;
            }
            ...
            if (System.Diagnostics.Debugger.IsAttached || ExtraSettings.DEBUG_ENABLED == true)
            {
                if (_packetNames.ContainsKey(Packet.Id))
                    log.Debug("Packet Recebido: [" + Packet.Id + "] " + _packetNames[Packet.Id]);
                else
                    log.Debug("Packet Recebido: [" + Packet.Id + "] UnnamedPacketEvent");
            }
