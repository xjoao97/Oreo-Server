...
namespace Quasar.Communication.Packets.Outgoing.LandingView
{
    class CommunityGoalComposer : ServerPacket
    {
        ...
        {
            int VOTE_LONG = QuasarEnvironment.GetGame().GetCommunityGoalVS().GetLeftVotes();
            int VOTE_SHORT = QuasarEnvironment.GetGame().GetCommunityGoalVS().GetRightVotes();
            ...
            base.WriteString(QuasarEnvironment.GetGame().GetCommunityGoalVS().GetName());
        ...
        /// </summary>
        /// <param name="A">Votos Esquerda</param>
        /// <param name="B">Votos Direita</param>
        /// <returns></returns>
