...
namespace Quasar.HabboHotel.Groups
{
    public class GroupManager
    {
            ...
            lock (this._groupLoadingSync)
            {
                ...
                using (IQueryAdapter dbClient = QuasarEnvironment.GetDatabaseManager().GetQueryReactor())
                {
                    ...
                    if (Row != null)
                    {
                        ...
                        catch { created = QuasarEnvironment.GetIUnixTimestamp(); }
                        Group = new Group(
        ...
        {
            Group = new Group(0, Name, Description, Badge, RoomId, Player.Id, (int)QuasarEnvironment.GetUnixTimestamp(), 0, Colour1, Colour2, 0, false, false);
