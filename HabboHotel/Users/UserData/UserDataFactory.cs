...
namespace Quasar.HabboHotel.Users.UserDataManagement
{
    public class UserDataFactory
    {
        public static UserData GetUserData(string SessionTicket, out byte errorCode)
        {
            ...
            {
                dbClient.SetQuery("SELECT `id` ,`username` , `password` , `auth_ticket` , `rank` , `vip_points` , `credits` , `activity_points` ,`gotw_points` ,`look` ,`gender` ,`motto` ,`mail` ,`account_created` ,`last_online` ,`online` ,`ip_last` ,`ip_reg` ,`home_room` ,`newbie_status` ,`is_muted` , `mutant_penalty` ,`mutant_penalty_expire` ,`trade_lock` ,`trade_lock_expire` ,`block_newfriends` , `hide_online` ,`hide_inroom` ,`vip` ,`vip_expire` ,`birth` ,`last_name_change` ,`client_volume` , `nux_passed` ,`fundom` , `facebook_id` ,`facebook_mail` ,`facebook_name` , `client_pin` ,`facebook_change` ,`facebook` ,`country_cf` ,`refer_count` , `radio` ,`change_name` ,`home_active` ,`home_active_security` ,`home_active_badges`, `home_active_rooms`,`home_active_friends`, `home_active_fb` , `home_active_twitter` , `home_active_instagram` ,`home_active_redes` , `home_active_diamonds` ,`home_active_duckets` ,`home_active_gotw` , `home_active_color` ,`home_active_colorc` ,`allow_pull` ,`country` ,`rank_vip` , `volume` ,`last_change` ,`machine_id` ,`focus_preference` , `chat_preference` , `pets_muted` , `bots_muted` , `advertising_report_blocked` , `ignore_invites` , `time_muted` ,`allow_gifts` , `trading_locked` , `friend_bar_state` , `disable_forced_effects` , `allow_mimic` , `cms_signature` , `forum_color` , `cms_currency` ,  `bot_frank` , `nux_user` ,`is_nuevo` , `name_color` ,`prefix_name` ,`prefix_name_color` ,`bubble_color` ,`bubble_id` , `publi` ,  `guia` , `builder` ,  `croupier` , `user_points` ,  `pumpkins` , `talent_status` , `staff_ocult` , `work` , `targeted_buy` , `frank_gift_count` , `bonus_points` ,`Lala` , `LalaAlert` , `LalaRecu` ,`LalaCod` ,`Lalacodcon` ,`ScoreGame` , `LalaConf` ,`cms_post` , `isMedal` , `Hjs` , `Datahoje` ,`Novato` , `Targetcont` ,`Vipss` , `Presidio` ,`Premiar` ,`cadstaff` , `DataHC` ,`allow_events` , `seckey` , `isNoob` , `in_staff_page` , `working` , `teamrank` , `fbid` , `fbenable` ,  `user_likes`,`pin`, `youtube` ,`pontos_evento` FROM `users` WHERE `auth_ticket` = @sso LIMIT 1"); 
            ...
            errorCode = 0;
            return new UserData(UserId, Achievements, favouritedRooms, tags, ignores, badges, friends, requests, rooms, quests, user, Relationships, subscriptions);
        }
        ...
        public static UserData GetUserData(int UserId)
        {
            ...
            Habbo user = HabboFactory.GenerateHabbo(dUserInfo, UserInfo);
            return new UserData(UserId, Achievements, FavouritedRooms, Tags, Ignores, Badges, Friends, FriendRequests, Rooms, Quests, user, Relationships, subscriptions);
        }
    }
}
