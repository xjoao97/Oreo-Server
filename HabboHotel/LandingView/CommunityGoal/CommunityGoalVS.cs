...
namespace Quasar.HabboHotel.LandingView.CommunityGoal
{
    public class CommunityGoalVS
    {
        private static readonly ILog log = LogManager.GetLogger("Quasar.HabboHotel.LandingView.CommunityGoalVS");
