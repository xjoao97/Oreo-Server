...
namespace Quasar.HabboHotel.Rooms
{
    public class RoomPromotion
    {
        ...
        {
            get { return (this.TimestampExpires - QuasarEnvironment.GetUnixTimestamp()) < 0; }
        }

        public int MinutesLeft
        {
            get { return Convert.ToInt32(Math.Ceiling((this.TimestampExpires - QuasarEnvironment.GetUnixTimestamp()) / 60)); }
        }
