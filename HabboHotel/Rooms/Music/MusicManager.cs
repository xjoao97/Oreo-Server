...
namespace Quasar.HabboHotel.Rooms.Music
{
    public class MusicManager
    {
        ...
        {
            get { return QuasarEnvironment.GetUnixTimestamp() - mStartedPlayingTimestamp; }
        }
        ...
        public int AddDisk(SongItem DiskItem)
        {
            ...
            SongData SongData = QuasarEnvironment.GetGame().GetMusicManager().GetSong(SongId);
        ...
        private void PlaySong()
        {
            ...
            mStartedPlayingTimestamp = QuasarEnvironment.GetUnixTimestamp();
            mBroadcastNeeded = true;
        }
