                ...
                if (ForSale.Group != null)
                {
                    ...
                    if (GroupID > 0)
                    {
                        ...
                        foreach (int UserID in ForSale.Group.GetAllMembers)
                        {
                            ...
                            GameClient UserClient = QuasarEnvironment.GetGame().GetClientManager().GetClientByUserID(UserID);
                            if (UserClient == null)
                                continue;
                    ...
                    QuasarEnvironment.GetGame().GetGroupManager().DeleteGroup(ForSale.Group.Id);
