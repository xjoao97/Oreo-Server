...
namespace Quasar.HabboHotel.Support
{
    ...
    public class ModerationTool
    {
        ...
        public static void SendTicketToModerators(SupportTicket Ticket)
        {
            ...
            QuasarEnvironment.GetGame().GetClientManager().StaffAlert(RoomNotificationComposer.SendBubble("tickets", "Hay una nueva petición de ayuda, revísala cuanto antes.", ""));
