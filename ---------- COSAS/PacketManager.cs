...
using Quasar.Communication.Packets.Incoming.Rooms.Music;
...
namespace Quasar.Communication.Packets
{
    public sealed class PacketManager
    {
        ...
        private void RegisterNavigator()
        {
            ...
            this._incomingPackets.Add(ClientPacketHeader.AddStaffRoomEvent, new AddStaffRoomEvent());
        }
        ...
        private void RegisterRoomEngine()
        {
            ...
            //this._incomingPackets.Add(ClientPacketHeader.BuyAndPlaceObjectMessageEvent, new BuyAndPlaceObjectEvent());
        ...
        public void RegisterNames()
        {
            ...
            //this._packetNames.Add(ClientPacketHeader.ConcurrentUsersCompetition, "ConcurrentUsersCompetition"); Termometro de Record de ONs
            ...
            this._packetNames.Add(ClientPacketHeader.AmbassadorWarningMessageEvent, "AmbassadorWarningMessageEvent");
            ...
            this._packetNames.Add(ClientPacketHeader.BuyAndPlaceObjectMessageEvent, "BuyAndPlaceObjectEvent");          
            ...
            this._packetNames.Add(ClientPacketHeader.AddPlaylistItemMessageEvent, "AddPlaylistItemEvent");
            this._packetNames.Add(ClientPacketHeader.GetJukeboxDisksMessageEvent, "GetJukeboxDisksEvent");
            this._packetNames.Add(ClientPacketHeader.GetJukeboxPlaylistsMessageEvent, "GetJukeboxPlaylistsEvent");
            this._packetNames.Add(ClientPacketHeader.GetMusicDataMessageEvent, "GetMusicDataEvent");
            this._packetNames.Add(ClientPacketHeader.RemovePlaylistItemMessageEvent, "RemovePlaylistItemEvent");
            this._packetNames.Add(ClientPacketHeader.SyncMusicMessageEvent, "SyncMusicEvent");
            ...
            //Bonus Rare
            this._packetNames.Add(ClientPacketHeader.RequestBonusRareEvent, "RequestBonusRareEvent");

            //ConcurrentUsers
            this._packetNames.Add(ClientPacketHeader.ConcurrentUsersCompetitionEvent, "ConcurrentUsersCompetition");
            this._packetNames.Add(ClientPacketHeader.GiveConcurrentUsersRewardEvent, "GiveConcurrentUsersReward");

            //Community Goal
            this._packetNames.Add(ClientPacketHeader.CommunityGoalEvent, "CommunityGoalEvent");
            this._packetNames.Add(ClientPacketHeader.CommunityGoalVoteEvent, "CommunityGoalVoteEvent");

            //Staff Selection
            this._packetNames.Add(ClientPacketHeader.AddStaffRoomEvent, "AddStaffRoomEvent");

            //Rentable
            this._packetNames.Add(ClientPacketHeader.BuyRentableSpaceEvent, "BuyRentableSpaceEvent");
            this._packetNames.Add(ClientPacketHeader.CancelRentableSpaceEvent, "CancelRentableSpaceEvent");

            //Nux Presents
            this._packetNames.Add(ClientPacketHeader.GetNuxPresentEvent, "GetNuxPresentEvent");
        }
    }
}