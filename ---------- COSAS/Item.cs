        ...
        public IFurniInteractor Interactor
        {
            get
            {
                ...
                switch (GetBaseItem().InteractionType)
                {
                    ...
                    //case InteractionType.TOTEM_PART:
                    //    return new InteractorTotemPart();

                    case InteractionType.TOTEM_BODY:
                        return new InteractorTotemBody();

                    case InteractionType.TOTEM_PLANET:
                        return new InteractorTotemPlanet();

                    //case InteractionType.PETBOX:
                    //    return new InteractorPetBox();
