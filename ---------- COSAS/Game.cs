...
using uasar.Communication.Packets.Outgoing.Nux;
...
namespace Quasar.HabboHotel
{
    public class Game
    {
        ...
        private readonly NewUserGiftsManager _newusergiftManager;
        private readonly NewUserGiftsListManager _newusergiftlistManager;
        ...
        public Game()
        {
            ...
            this._newusergiftManager = new NewUserGiftsManager();
            this._newusergiftManager.Initialize(QuasarEnvironment.GetDatabaseManager().GetQueryReactor());

            this._newusergiftlistManager = new NewUserGiftsListManager();
            this._newusergiftlistManager.Initialize(QuasarEnvironment.GetDatabaseManager().GetQueryReactor());
        ...
        internal NewUserGiftsManager GetNewUserGiftsManager()
        {
            return _newusergiftManager;
        }

        internal NewUserGiftsListManager GetNewUserGiftsListManager()
        {
            return _newusergiftlistManager;
        }
